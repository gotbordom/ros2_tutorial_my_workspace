...
int main(int argc, char **argv)
{
  ...
  // Replacing this with my own custom add three ints interface
  // std::shared_ptr<rclcpp::Node> node = rclcpp::Node::make_shared("add_two_ints_client");
  // rclcpp::Client<example_interfaces::srv::AddTwoInts>::SharedPtr client =
  //   node->create_client<example_interfaces::srv::AddTwoInts>("add_two_ints");
  std::shared_ptr<rclcpp::Node> node = rclcpp::Node::make_shared("add_three_ints_client");
  rclcpp::Client<my_interface_package_cpp::srv::AddThreeInts>::SharedPtr client =
    node->create_client<my_interface_package_cpp::srv::AddThreeInts>("add_three_ints");

  // auto request = std::make_shared<example_interfaces::srv::AddTwoInts::Request>();
  auto request = std::make_shared<my_interface_package_cpp::srv::AddThreeInts::Request>();
